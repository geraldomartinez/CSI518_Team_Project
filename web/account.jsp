        ...
        <div id="page_wrapper">
            ...
            <div id="account_info">
                ...
                <table>
                    <tr>
                        <td>
                            <div id="account_balance">Checking Balance: $<%= String.format("%.2f", usr.GetCheckingBalance())%></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div id="account_balance">Savings Balance: $<%= String.format("%.2f", usr.GetSavingsBalance())%></div>
                        </td>
                    </tr>
                </table>
                <br />
